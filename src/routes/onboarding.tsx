    ...
    <div className="min-h-screen w-full" style={{ background: "var(--color-bg-primary)" }}>
      ...
      >
        ...
        <div className="flex flex-col items-center px-6 pt-24 pb-8 text-center">
          <h1 className="font-display font-semibold" style={{ fontSize: 48, color: "#A32D2D", letterSpacing: "-0.02em" }}>
            TRİBÜN
          </h1>
        ...
        <div className="flex-1 space-y-3 px-6">
          <div className="flex h-14 items-center gap-3 rounded-full bg-surface px-4" style={{ border: "1px solid var(--color-border)" }}>
          ...
          <div className="space-y-3 rounded-2xl bg-surface p-4" style={{ border: "1px solid var(--color-border)" }}>
            <div className="font-display font-semibold text-[16px]">Takımını seç</div>
            <div className="grid grid-cols-4 gap-2">
              {[
                { code: "GS", bg: "linear-gradient(135deg,#FDB912,#A90432)" },
                { code: "FB", bg: "linear-gradient(135deg,#FFE600,#00296B)" },
                { code: "BJK", bg: "linear-gradient(135deg,#FFFFFF,#1A1A1A)" },
                { code: "TS", bg: "linear-gradient(135deg,#8B0000,#003F87)" },
              ].map((t) => (
                <button key={t.code} className="flex flex-col items-center gap-1 rounded-xl p-2 transition-colors hover:bg-bg-secondary">
                  <span className="flex h-12 w-12 items-center justify-center rounded-full text-white font-display font-semibold text-[14px]" style={{ background: t.bg }}>
                    {t.code}
                  </span>
                </button>
              ))}
        ...
        <div className="px-6 pb-8 pt-4">
          <Link
            to="/kyc"
            className="flex h-14 w-full items-center justify-center rounded-full font-sans font-medium text-[16px] text-white"
