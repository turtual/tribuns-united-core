...
type Team = {
  id: string;
  name: string;
  // Pill colors for the placeholder crest (no icons allowed)
  base: string;
  stripe: string;
  text: string;
};
...
function TeamCrest({ team }: { team: Team }) {
  return (
    ...
    >
      ...
      />
      <span
        className="relative t-tiny font-display"
    ...
    <div className="min-h-screen bg-bg-primary text-text-primary">
      <div className="mx-auto w-full max-w-[393px] min-h-screen flex flex-col px-6 pt-16 pb-10">
        ...
        <section className="mt-10 flex-1">
          ...
          >
            <span className="flex items-center gap-1.5 t-body-lg text-text-primary">
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none t-body-lg text-text-primary placeholder:text-text-tertiary"
          ...
          <div className="mt-7">
            ...
            <div className="mt-4 flex justify-center">
              <button
                type="button"
                className="t-body-sm text-text-secondary underline underline-offset-4 decoration-border hover:decoration-text-secondary"
              >
                Diğer takımlar
              </button>
            </div>
